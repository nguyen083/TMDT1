	...
	<?php if( get_theme_mod( 'grocery_ecommerce_single_post_date',true) != '' || get_theme_mod( 'grocery_ecommerce_single_post_author',true) != '' || get_theme_mod( 'grocery_ecommerce_single_post_comment_no',true) != '' || get_theme_mod( 'grocery_ecommerce_single_post_time',true) != '') { ?>
	    <div class="post-info p-2 mb-2">
	      <?php if( get_theme_mod( 'grocery_ecommerce_single_post_date',true) != '') { ?>
	        <i class="<?php echo esc_attr(get_theme_mod('grocery_ecommerce_singlepost_date_icon',"fa fa-calendar pe-2" )); ?>"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><span class="entry-date pe-3"><?php echo esc_html( get_the_date() ); ?></span><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a>
	      <?php }?>

				...
				<div class="col-lg-4 col-md-4">
				    <article class="blog-sec text-start p-2 mb-4">
			            ...
			            <?php if(get_the_excerpt()) { ?>
			                <div class="entry-content"><p><?php $grocery_ecommerce_excerpt = get_the_excerpt(); echo esc_html( grocery_ecommerce_string_limit_words( $grocery_ecommerce_excerpt, esc_attr(get_theme_mod('grocery_ecommerce_related_post_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('grocery_ecommerce_button_excerpt_suffix','...') ); ?></p></div>
				        <?php }?>

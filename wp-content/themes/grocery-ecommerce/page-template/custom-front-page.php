...
<main id="maincontent" role="main">
  ...
  <?php if(get_theme_mod('grocery_ecommerce_show_slider') != '' || get_theme_mod('grocery_ecommerce_slider_responsive') != ''){ ?>
              ...
              <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
                ...
                <div class="carousel-caption">
                  <div class="inner_carousel">
                    ...
                    <?php }?>
                    <?php if(get_theme_mod('grocery_ecommerce_slider_button',true) != '' || get_theme_mod('grocery_ecommerce_slider_button_responsive',true) != '') {?>

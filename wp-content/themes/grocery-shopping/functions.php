...
function grocery_shopping_logo_resizer() {
	...
	';
    wp_add_inline_style( 'grocery-shopping-style',$theme_logo_size_css );
...
function grocery_shopping_global_color() {
	...
	';
    wp_add_inline_style( 'grocery-shopping-style',$theme_color_css );
    wp_add_inline_style( 'grocery-shopping-woocommerce-css',$theme_color_css );
...
if (!function_exists('grocery_shopping_loop_columns')) {
	function grocery_shopping_loop_columns() {
		$columns = get_theme_mod( 'grocery_shopping_per_columns', 3 );
		return $columns;
	}
}
...
function grocery_shopping_per_page( $cols ) {
  	$cols = get_theme_mod( 'grocery_shopping_product_per_page', 9 );
	return $cols;
}

add_action( 'wp_enqueue_scripts', 'grocery_shopping_load_dashicons_front_end' );
function grocery_shopping_load_dashicons_front_end() {
